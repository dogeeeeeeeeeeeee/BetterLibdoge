document.addEventListener('DOMContentLoaded', () => {
    ...
    document.getElementById('import-button').addEventListener('click', () => {
        alert("Are you sure? (this will overwrite your current dictionary)");
        ...
        fileInput.addEventListener('change', (event) => {
            ...
            try {
                ...
                if (importedData && importedData.meta && importedData.content) {
                chrome.storage.local.set({ globaldictionary: importedData }, () => {
                    alert('Dictionary imported successfully!');
                    updateDisplay();
                });
                } else {
                alert('Invalid dictionary format.');
                }
            } catch (err) {
